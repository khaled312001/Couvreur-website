 ...
 * Upload this file to: public_html/api/complete_update.php
 * Visit: https://api.bnbatiment.com/complete_update.php?password=update2024
 */

$password = $_GET['password'] ?? '';
if ($password !== 'update2024') die('Access denied');

echo "<h1>🚀 Complete Service Images Update</h1>";
...
try {
    ...
    // Step 2: Load Laravel and update services
    echo "<h2>Step 2: Loading Laravel Framework</h2>";
    ...
    echo "<h2>Step 4: Updating Service Images</h2>";
    ...
    echo "<h2>Step 6: Image Verification</h2>";
    $imageFiles = [
    ...
    echo "<p>Checking image files in: {$uploadsPath}</p>";
    ...
    echo "<p><strong>✅ All services have been updated with images!</strong></p>";
    echo "<p>You can now check your website:</p>";
    echo "<ul>";
    echo "<li><a href='https://bnbatiment.com' target='_blank'>Homepage</a></li>";
    echo "<li><a href='https://bnbatiment.com/services' target='_blank'>Services Page</a></li>";
    echo "</ul>";
    echo "</div>";
    
    echo "<p style='color:red;font-weight:bold;margin-top:20px;'>⚠️ IMPORTANT: Delete this file after use for security!</p>";
