...
const Lyon = () => {
  ...
  const advantages = [
    ...
    },
    {
      ...
      description: 'Plus de 200 clients satisfaits à Lyon'
    }
  ];
  ...
  const testimonials = [
    {
      ...
      city: 'Lyon 3ème',
      rating: 5,
      comment: 'Excellent service ! Intervention rapide pour une fuite de toiture. Travail soigné et professionnel. Je recommande vivement.'
    },
    {
      name: 'Pierre L.',
      city: 'Lyon 6ème',
  ...
  return (
    <>
      ...
      <main className="lyon-services-page">
        {/* Hero Section */}
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-800 mb-4">
                Nos Services de Toiture à Lyon
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Découvrez notre gamme complète de services de toiture professionnels, 
                adaptés aux spécificités climatiques de Lyon et sa région.
              </p>
            </div>
                ...
                >
                  <div className="grid md:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="text-center">
                      <OptimizedImage
                        src={service.image}
                        alt={`${service.title} à Lyon - BN BÂTIMENT`}
        ...
        <section className="advantages-section py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-800 mb-4">
                Pourquoi Choisir BN BÂTIMENT à Lyon ?
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Notre expertise et notre engagement qualité font de nous le partenaire 
                de confiance pour tous vos travaux de toiture à Lyon.
              </p>
            </div>
        ...
        <section className="testimonials-section py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-800 mb-4">
                Avis de Nos Clients à Lyon
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Découvrez ce que disent nos clients satisfaits de nos services de toiture à Lyon.
              </p>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-white mb-4">
                Besoin d'un Devis Gratuit à Lyon ?
              </h2>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p>Lyon et région (100km autour)</p>
                    </div>
                  </div>
                </div>
              </div>
