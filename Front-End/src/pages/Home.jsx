  ...
  const heroSlides = [     
    {
      ...
      title: 'Uhrhan Roger : Couvreur Zingueur',
    ...
    {
      id: 3,
      image: 'https://images.unsplash.com/photo-1581578731548-7f23fd1e3c6d?ixlib=rb-4.0.3&auto=format&fit=crop&w=2074&q=80',
          ...
          <div className="about-grid">
            <div className="about-content fade-in-on-scroll">
              ...
              <div className="about-description">
                <p>
                  Uhrhan Roger Couverture vous accompagne dans tous vos projets de toiture dans la région de Rochemaure. 
              ...
              <div className="about-features">
                <div className="about-feature fade-in-on-scroll" style={{animationDelay: '0.1s'}}>
                  ...
                  <div className="feature-content">
                    ...
                    <p>
                      Fort de 11 ans d'expérience, Uhrhan Roger dispose de toute l'expertise professionnelle 
                ...
                <div className="about-feature fade-in-on-scroll" style={{animationDelay: '0.4s'}}>
                  ...
                  <div className="feature-content">
                    ...
                    <p>
                      Uhrhan Roger, votre entreprise de couverture à Rhône-Alpes, est pleinement 
            ...
            <div className="about-visual fade-in-on-scroll">
              <div className="worker-illustration">
                ...
                <div className="experience-badge">
                  <div className="badge-number">11</div>
            ...
            <div className="quality-content fade-in-on-scroll">
              ...
              <div className="quality-features">
                ...
                <div className="quality-feature">
                  ...
                  <div className="feature-text">
                    <h3>Fiabilité</h3>
                    <p>Plus de 15 ans d'expérience dans le secteur</p>
                  </div>
                </div>
                <div className="quality-feature">
          ...
          <div className="services-grid grid grid-3">
            <div className="service-card card fade-in-on-scroll" style={{animationDelay: '0.1s'}}>
              <div className="service-image">
                <img src="https://images.unsplash.com/photo-1581578731548-c64695cc6952?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" alt="Rénovation de toiture" />
              </div>
            ...
            <div className="service-card card fade-in-on-scroll" style={{animationDelay: '0.2s'}}>
              <div className="service-image">
                <img src="https://images.unsplash.com/photo-1504307651254-35680f356dfd?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" alt="Réparation de toiture" />
              </div>
              <div className="card-content">
            ...
            <div className="service-card card fade-in-on-scroll" style={{animationDelay: '0.3s'}}>
              <div className="service-image">
                <img src="https://images.unsplash.com/photo-1581578731548-7f23fd1e3c6d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" alt="Entretien de toiture" />
              </div>
              <div className="card-content">
